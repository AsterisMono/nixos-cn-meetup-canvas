/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: e743a2eab915e3358500a5edccb46e71)
// Runtime types generated with workerd@1.20250803.0 2024-12-30 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXTJS_ENV: string;
		ORDER_ID: DurableObjectNamespace<import("./src/cloudflare/worker").OrderId>;
